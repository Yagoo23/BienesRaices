    ...
    <section class="seccion contenedor">
        ...
        <div class="contenedor-anuncios">
            ...
            <div class="anuncio">
                ...
                <div class="contenido-anuncio">
                    <h3>Casa Moderna con Piscina</h3>
                    <p>Casa en el lago con excelente vista, acabados de lujo a un excelente precio.</p>
                    <p class="precio">3.000.000€</p>
                    <ul class="iconos-caracteristicas">
                        <li>
    ...
    <section class="imagen-contacto">
        ...
        <p>Llena el formulario de contacto y un asesor se pondrá en contacto contigo pronto.</p>
            ...
            <article class="entrada-blog">
                ...
                <div class="texto-entrada">
                    <a href="entrada.php">
                        ...
                        <p class="informacion-meta">Escrito el <span>29/09/2023</span> por <span>Admin.</span></p>
            ...
            <article class="entrada-blog">
                ...
                <div class="texto-entrada">
                    <a href="entrada.php">
                        ...
                        <p class="informacion-meta">Escrito el <span>29/09/2023</span> por <span>Admin.</span></p>
                        <p>Maximiza el espacio en tu hogar con esta guía, aprender a combinar muebles y colores para
